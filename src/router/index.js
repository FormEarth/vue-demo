...
const router = new Router({
  ...
  routes: [
    ...
    { path: '/atlas', name: 'atlasList', meta: { title: "图集", requireLogin: false ,nav:"atlas"}, component: atlasList },
    { path: '/atlas/detail/:id', name: 'atlas', meta: { title: "图集详情", requireLogin: false ,nav:"atlas"}, component: atlas },
