...
const router = new Router({
  ...
  mode: 'history',
  routes: [
    { path: '/', name: 'home1', meta: { title: "首页", requireLogin: false }, component: home },
    { path: '/home/new', name: 'mhome', meta: { title: "首页", requireLogin: true }, component: home_new },
    ...
    { path: '/album', name: 'album', meta: { title: "相册", requireLogin: false }, component: album },
